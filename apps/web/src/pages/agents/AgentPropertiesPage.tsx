...
export default function AgentProperties() {
  ...
  const { data, isLoading, refetch } = useQuery({
    queryKey: ["agent-properties", page],
    queryFn: () => PropertyService.list({ page, limit: 10 }),
  });
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-[var(--color-brand-text)]">My Listings</h1>
      ...
      {properties.length === 0 ? (
        <Card className="text-center py-12">
          ...
          <h3 className="text-lg font-semibold text-gray-600">No Listings Yet</h3>
          <p className="text-gray-400 mt-1">Start by adding your first property listing</p>
          <Link to="/agent/properties/create">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-2 mt-4">
                    ...
                    <Link to={`/agent/properties/${property._id}/edit`}>
