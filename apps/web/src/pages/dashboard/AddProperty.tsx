...
import { Building2, MapPin, Bed, Bath, Toilet, Sofa, Image as ImageIcon, X, Plus } from "lucide-react";
...
export function AddProperty({ userRole, redirectPath }: AddPropertyProps) {
  ...
  const handleFeatureChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setFormData(prev => ({
      ...prev,
      features: { ...prev.features, [name]: parseInt(value) || 0 }
    }));
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex gap-4 justify-end">
        <Button type="button" variant="ghost" onClick={() => navigate(redirectPath)}>
          Cancel
        </Button>
